...
fs = 16000;
DataSetPath='D:\Collaborations\Biometrics fusion\My data\Voice Experiment\DataSet\Voice dataset after splitting\Train\';

training_data1 = wavread(strcat(DataSetPath,'FAML_Sa_1.wav'));
testing_data1  = wavread(strcat(DataSetPath,'FAML_Sa_2.wav'));
